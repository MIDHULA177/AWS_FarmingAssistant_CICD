  ...
  return (
    <div className={styles.popupOverlay}>
      <div className={styles.popupCard}>
        <div className={styles.popupIcon}>{type === 'success' ? '✅' : '❌'}</div>
        <p className={`${styles.popupMessage} ${type === 'success' ? styles.popupSuccess : styles.popupError}`}>
          {message}
        </p>
        <button onClick={onClose} className={`${styles.popupBtn} ${type === 'success' ? styles.popupBtnSuccess : styles.popupBtnError}`}>OK</button>
      </div>
    </div>
  );
}
